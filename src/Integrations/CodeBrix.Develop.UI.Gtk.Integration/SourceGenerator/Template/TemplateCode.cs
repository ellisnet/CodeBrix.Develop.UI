        ...
        return $$"""
                {{data.TypeData.Properties.Accessibility}} partial class {{data.TypeData.Properties.NameGenericArguments}}
                {
                    ...
                    static partial void CompositeTemplateClassInit(System.IntPtr cls, System.IntPtr clsData)
                    {
                        ...
                        var classHandle = new global::CodeBrix.Develop.UI.Gtk.Internal.WidgetClassUnownedHandle(cls);
                        global::CodeBrix.Develop.UI.Gtk.Internal.WidgetClass.SetTemplate(
                    ...
                    {
                        global::CodeBrix.Develop.UI.Gtk.Internal.Widget.InitTemplate(instance);
                    }

                    {{GeneratedCodeAttribute.Render()}}
                    static partial void CompositeTemplateDispose(System.IntPtr instance)
                    {
                        global::CodeBrix.Develop.UI.Gtk.Internal.Widget.DisposeTemplate(instance, GType);
                    }
