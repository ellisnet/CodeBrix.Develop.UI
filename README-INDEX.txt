================================================================================
README-INDEX: CodeBrix.Develop.UI
...
------------------------------------------------------------------
  AGENT-README.txt
      CodeBrix.Develop.UI — a fully managed C# binding of GTK 4, the
      GtkSourceView 5 code editor, and the supporting GNOME platform libraries
      (Gdk, Gsk, Gio, GObject, GLib, Pango, PangoCairo, Cairo, HarfBuzz,
      FreeType2, GdkPixbuf, Graphene) for .NET 10 or later.
